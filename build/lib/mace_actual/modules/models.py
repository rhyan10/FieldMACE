...
class FieldEMACE(torch.nn.Module):
    ...
    def forward(
        ...
        #data["mm_positions"][zero_mask] = 1e12
        ...
        #multipoles = compute_ewald_sum_loop(data["positions"], mm, data["mm_charges"])
        #multipoles = compute_columb_potential(data["positions"], data["mm_positions"], data["mm_charges"])
        multipole_attrs = self.multipole_spherical_harmonics(data["positions"])
