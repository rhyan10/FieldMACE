...
class MACECalculator(Calculator):
    ...
    def calculate(self, atoms=None, properties=None, system_changes=all_changes):
        ...
        for i, model in enumerate(self.models):
            ...
            H_si = H.reshape(36, 36) * 16.02176634
            ...
            normal_modes = normal_modes.T.reshape(num_modes, 12, 3)  # Shape: (-1, num_atoms, 3)
            vals = vals[6:]
        ...
        if self.model_type in ["MACE", "EnergyDipoleMACE"]:
            ...
            self.results["forces"] = ret_tensors["forces"].cpu().numpy() * self.energy_units_to_eV
